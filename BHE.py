...
import random as rd
# ©$⁡⁮‮⁯‫⁯⁮‭⁠⁯‍‌‌‌‌‌⁯‍⁯‭‭‭​⁥‌‪⁯‌‪‪‌‪⁯͏‌‌‌‌‌⁠⁯⁥͏⁯‬​⁠͏⁯‌‌᠎⁭‌‪⁯⁮⁤᠋‌‌‎⁯​⁣‪‪‭⁯‭‫⁯‮⁥͏‬⁥⁫‭⁯͏⁯⁠‎⁯‪⁭‭⁯⁡‭‎⁯͏⁭⁣⁠⁯⁥⁠͏⁯⁥‎⁯‎⁯⁨‫⁯‪‍⁯‌‮⁯⁬͏⁯⁫⁫⁦᠋⁤͏⁯⁠⁩‌⁯‍⁥‪⁯‬‭⁦‪⁭⁫‭⁯‫⁥⁠͏‌⁯‪⁯⁫‭⁯᠎‭⁯‫​‫‍‮⁯⁭⁠⁯⁩⁨⁠‭⁦⁠⁠⁯‮⁡‮‪‌⁯⁣‍‌⁯⁠⁠᠎⁬‪⁦⁩‌‍⁯‬‎⁯‫‫⁯‮‍​‫⁯‍‫⁯‭͏⁯‪‪⁯‫⁯‫⁯᠋‌͏‭⁯‌⁯‌⁨͏⁥⁭⁠‪‍⁯⁡​‮⁯⁥‌͏⁯‪‎⁯‌‭‭⁦⁠⁯⁨⁠⁤͏‪⁮᠋‫‬‪‪‌‮⁯‪⁯‭‍‪⁯͏⁯⁭‌͏͏⁯⁠‮⁯‮‌⁩⁩᠎‮⁯⁩⁫͏‪‍⁯⁡⁡‎⁯⁠⁣⁠⁥⁠‮⁯‫‮⁯‭‌⁯⁮‪⁬‮⁯⁫⁤⁫‮⁯⁣‫‪‮͏⁯‎⁯͏⁬᠎‪⁯⁩‎⁯⁤͏͏⁯‮⁯‭⁯‎⁯⁥⁮‪‫‮͏⁯⁩‮⁥​͏͏⁯᠎‮⁣‍͏᠋᠎​‍⁯⁠⁯​‍⁯‮⁦᠋͏⁯⁭‎⁯᠋‎⁯⁥‭⁥⁩‎⁯‭⁯⁮‭⁯‮⁯‍⁠⁮⁮‫⁯‭͏⁯᠎‫‫‌⁯‭⁯⁨⁦⁮⁦⁨⁥‍‮⁯‫‫⁤⁩᠎⁠⁣‎⁯⁥‎⁯᠋‮⁯‍⁠⁦⁬⁦⁨‮͏⁯‍⁯⁬⁥​‪⁤⁦⁣͏⁯‍⁯᠎‭⁯‭​‫⁣‍⁯‭⁯⁦‪⁡‮⁯‌⁮‪‫⁭‪⁯᠎‮⁯‌⁫⁠⁯‪⁯‭⁯‮⁯͏⁯⁤⁡‌‫⁯‫⁯⁨⁮⁬‫‌‍⁯͏‫⁯‫⁯⁨‪⁯‮⁦‭͏‪⁯‌⁦‭⁩‎⁯⁭‌⁯‪‌⁯⁮᠎᠎⁮⁡⁩‫⁯͏⁯⁭⁩‌‫‮⁯‬⁭⁨⁮‭⁯⁨​⁡‮⁯᠋⁤⁦⁠⁯⁨⁦⁤‎⁯᠋⁠⁯‫⁣͏⁫‌⁯⁫͏‫⁯⁡⁠‍͏‮⁯⁡͏⁯͏⁦‬͏‫⁯⁭‬͏⁠᠎⁠‪⁤⁦‭⁯‮‍⁯᠎‍⁬‍⁦‫⁯⁭‭⁯‍⁡⁬͏‬‫⁯‌‌⁯‍⁯᠋⁮‍‮⁯⁤͏⁠⁯⁡‌⁯​⁠‪⁯‪⁬͏⁯‮⁯⁩⁣᠎⁭‭‍⁯⁬‪⁯‍⁦⁫⁭᠋͏⁩᠎⁮⁥᠎‎⁯‌⁯᠎​‪⁯‮⁯‭᠋‭⁯͏‎⁯⁮‫⁯‍‫⁤⁦⁮⁩⁨⁨‍͏⁯᠋‫᠋᠋᠋‬͏⁯⁡‪⁦⁨⁡‫⁯⁮‌⁥⁨‫‍͏͏‫‮⁯͏⁨‌⁯‪͏‍⁦⁠⁯⁬⁠⁯⁮‎⁯‭⁠⁯‫‬‍᠎᠎⁥‭⁯᠎​͏⁯‍⁯⁩‪⁮‮⁣‍͏⁯⁡‌⁯‪᠎⁦‮᠋⁥⁠⁯⁠⁯⁨᠋‮⁯‫⁨⁫⁭‍⁯‭‪⁯⁬‬‌⁯⁤⁫‮⁯͏⁯᠋‮‌⁯⁨‍⁯‫⁯‫⁯‪⁤⁮⁠⁯͏‪⁬‫⁣‪⁯‭⁯‍⁯⁨‍⁯⁣⁥⁫⁠‭⁯‍⁯͏⁮‫⁠‫⁯‫⁭‌‮‭⁯⁤⁭‬‭‫⁬‌⁫⁮‎⁯⁬᠎⁨͏⁯⁬​͏⁯⁩⁠⁯͏⁯‪⁤᠋‮‎⁯⁣‬᠋⁦‎⁯‎⁯‌͏‬᠋‭‭⁯‬⁭​‌⁬‪⁯᠋‮⁯⁡⁠‪‫⁯‍⁥⁨⁣⁣⁦⁥‌⁯⁨⁩͏‌‌᠎͏‍⁩⁭‪⁯⁡‬⁦⁠⁯‭⁯⁨‭‪‌‍⁠⁯‌‪⁩⁭⁥⁡‍‬⁦‫⁯‫⁯‭‫⁯᠎‮⁯⁨⁩‍‭⁥‌⁬͏⁡⁩⁩͏⁩‫⁥‮⁯⁨‮⁯⁬‎⁯‫⁯⁮‫⁮⁩⁠⁯‌‫⁠⁯‮⁯⁨⁠‫⁯⁡͏⁠‍⁯⁠⁯⁨‍⁯⁩͏​͏‌͏⁯⁠⁫⁦‎⁯‮⁯‍⁫⁭‫‌⁯⁤‭⁮⁡͏⁯᠎‪‭⁡⁦‬‫⁯‮‪⁯‍‌​⁡‫᠎⁨⁣‬‫⁦͏‍‎⁯͏᠎⁨‌⁯⁡͏‮⁯͏⁮⁮‎⁯⁨⁬⁭‌‫⁯⁫⁨‫⁯‍⁯‍​‭‮⁯‫‍⁯⁤⁦‫⁯⁥͏‬⁠⁯‮⁩‎⁯‫​⁦​⁫‍͏‭‍⁯‫‬͏⁫‎⁯‍⁯⁡͏⁯⁠⁯⁣‎⁯᠎‍⁯‭⁯‫⁨​‪⁤᠎⁦⁡⁠᠎‌⁯⁬‌⁯‌⁯‭⁯‮⁯‪⁯‫⁯‌⁠⁯‍⁯‬‫⁮‍⁯⁦⁤⁨⁫​‭‍⁯​‌⁠‪⁥⁭᠎⁤⁫⁡⁥‮‭‫᠎‮⁯‌‎⁯⁥‮⁯‬‬⁩͏⁤͏‫⁯⁦‍⁯‪⁯⁮⁡‌⁯‌⁯⁩⁨͏⁯⁡⁭⁫⁨⁡‭⁯⁬͏⁯‫⁯‮⁯᠎​⁩⁩​⁫⁠⁯‮⁯‮‌‌‌‌‌‌͏‪⁬‫͏‍⁯͏⁯⁮᠋‫⁦⁭⁨‌‌⁥‮⁯‮‪⁯⁫⁮⁥‌‌‌͏⁯‍⁯‭⁫​‫⁯⁠⁨͏‪⁯⁨⁡᠋‎⁯‪⁯‌‌‌‌‌‌‌‮‭⁤‍
...
def fileEncode(key, file):
	...
	open(f"BHE(enc)_{file}.txt","w").write(encode(f"{data}{IPR}", map))
	print(f"save encode file at BHE(enc)_{file}.txt")

def fileDecode(key, file):
	map = new_map(orig_map, key)
	data = open(f"{file}","r").read()
	open(f"BHE(dec)_{file}.txt","w").write(decode(data, map))
	print(f"save encode file at BHE(dec)_{file}.txt")
